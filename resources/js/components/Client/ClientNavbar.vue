...
<template>
    <header class="sticky top-0 z-40 border-b border-slate-200 bg-white/90 backdrop-blur">
        <div class="mx-auto flex w-full max-w-6xl items-center justify-between gap-6 px-3 py-4">
            ...
            <nav class="hidden items-center gap-2 rounded-full bg-emerald-50 px-2 py-1 text-sm font-medium text-slate-600 md:flex">
                <component
            ...
            <div class="flex items-center gap-3">
                ...
                <div class="hidden items-center gap-2 rounded-full border border-slate-200 bg-white px-4 py-1.5 shadow-sm sm:flex">
